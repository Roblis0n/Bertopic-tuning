# Publication Decision Report Sections

Use these extended sections only when the selected assurance level or an
explicit research claim requires them. Do not emit empty headings.
