# Publication/Release BERTopic Workflow

Use this complete workflow only when `assurance_level` is
`publication_release`. It preserves the former strict preview, audit,
visualization, lineage, and release chain without imposing those obligations on
exploratory or ordinary research tuning.
